...
# Fixing path for Ubuntu Users

test_img_path = 'realtime_measurement-master\\test_images\\test4.jpg'
w_a4 = 210
h_a4 = 297
scale = 3
# for path in os.listdir("realtime_measurement-master\\test_image"):
...
if len(contours) != 0:
    biggest_rect = contours[0][1] # area and approx corners
    warp_img = warp_image(
